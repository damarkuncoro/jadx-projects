...
import static dexforge.zip.parser.DexforgeZipParser.bufferToStream;

final class ZipDeflate {
	private static final int BUFFER_SIZE = 4096;

	static byte[] decompressEntryToBytes(ByteBuffer buf, DexforgeZipEntry entry) throws DataFormatException {
	...
	static InputStream decompressEntryToStream(ByteBuffer buf, DexforgeZipEntry entry) {
