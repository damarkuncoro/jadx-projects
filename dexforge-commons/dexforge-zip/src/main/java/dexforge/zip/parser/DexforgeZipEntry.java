...
public final class DexforgeZipEntry implements IZipEntry {
	private final DexforgeZipParser parser;
	...
	DexforgeZipEntry(DexforgeZipParser parser, String fileName, int entryStart, int dataStart,
