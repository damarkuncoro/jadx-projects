...
public class ZipReader {
	...
	public ZipReader(Set<ZipReaderFlags> flags) {
		this(new ZipReaderOptions(new DexforgeZipSecurity(), flags));
	}

	public ZipReader(IDexforgeZipSecurity security) {
	...
	public ZipContent open(File zipFile) throws IOException {
		...
		try {
			DexforgeZipParser jadxParser = new DexforgeZipParser(zipFile, options);
	...
	private IZipParser detectParser(File zipFile, DexforgeZipParser jadxParser) throws IOException {
