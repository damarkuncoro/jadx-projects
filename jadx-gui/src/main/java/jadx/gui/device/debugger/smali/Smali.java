...
import static dexforge.api.plugins.input.data.AccessFlagsScope.FIELD;
import static dexforge.api.plugins.input.data.AccessFlagsScope.METHOD;
import static dexforge.api.plugins.input.insns.Opcode.CONST;
import static dexforge.api.plugins.input.insns.Opcode.CONST_METHOD_HANDLE;
import static dexforge.api.plugins.input.insns.Opcode.CONST_METHOD_TYPE;
import static dexforge.api.plugins.input.insns.Opcode.CONST_WIDE;
import static dexforge.api.plugins.input.insns.Opcode.FILLED_NEW_ARRAY;
import static dexforge.api.plugins.input.insns.Opcode.FILLED_NEW_ARRAY_RANGE;
import static dexforge.api.plugins.input.insns.Opcode.FILL_ARRAY_DATA_PAYLOAD;
import static dexforge.api.plugins.input.insns.Opcode.INVOKE_CUSTOM;
import static dexforge.api.plugins.input.insns.Opcode.INVOKE_CUSTOM_RANGE;
import static dexforge.api.plugins.input.insns.Opcode.INVOKE_POLYMORPHIC;
import static dexforge.api.plugins.input.insns.Opcode.INVOKE_POLYMORPHIC_RANGE;
import static dexforge.api.plugins.input.insns.Opcode.PACKED_SWITCH;
import static dexforge.api.plugins.input.insns.Opcode.PACKED_SWITCH_PAYLOAD;
import static dexforge.api.plugins.input.insns.Opcode.SPARSE_SWITCH;
import static dexforge.api.plugins.input.insns.Opcode.SPARSE_SWITCH_PAYLOAD;
