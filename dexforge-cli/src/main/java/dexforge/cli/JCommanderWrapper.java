...
public class JCommanderWrapper {
	...
	private final DexforgeCLIArgs argsObj;

	public JCommanderWrapper(DexforgeCLIArgs argsObj) {
		...
		DexforgeCLICommands.append(builder);
	...
	public void overrideProvided(DexforgeCLIArgs obj) {
		applyFiles(obj);
	...
	public boolean processCommands() {
		...
		return DexforgeCLICommands.process(this, jc, parsedCommand);
	}

	/**
	 * The main parameter parsing doesn't work if accepting unknown options
	 */
	private void applyFiles(DexforgeCLIArgs argsObj) {
	 ...
	 */
	private static void overrideProperty(DexforgeCLIArgs obj, ParameterDescription parameter) {
	...
	public void printUsage() {
		...
		out.println("  DEXFORGE_CONFIG_DIR / JADX_CONFIG_DIR - custom config directory, using system by default");
		out.println("  DEXFORGE_CACHE_DIR / JADX_CACHE_DIR - custom cache directory, using system by default");
		out.println("  DEXFORGE_TMP_DIR / JADX_TMP_DIR - custom temp directory, using system by default");
		out.println();
