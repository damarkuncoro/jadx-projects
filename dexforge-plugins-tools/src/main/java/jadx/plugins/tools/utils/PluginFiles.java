...
public class PluginFiles {
	...
	private static final Path PLUGINS_DIR = DexforgeCommonFiles.getConfigDir().resolve("plugins");
	...
	public static final Path PLUGINS_LIST_CACHE = DexforgeCommonFiles.getCacheDir().resolve("plugin-list.json");
