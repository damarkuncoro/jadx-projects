...
public class AaptProtoParser {

	public ProtoValue parse(Resources.Style s) {
	...
	public ProtoValue parse(Resources.Styleable s) {
		List<ProtoValue> namedValues = new ArrayList<>(s.getEntryCount());
		for (int i = 0; i < s.getEntryCount(); i++) {
	...
	public ProtoValue parse(Resources.Array a) {
	...
	public ProtoValue parse(Resources.Attribute a) {
	...
	public ProtoValue parse(Resources.Plural p) {
	...
	public ProtoValue parse(Resources.CompoundValue c) {
	...
	public String parse(ConfigurationOuterClass.Configuration c) {
	...
	public String parse(Resources.Item i) {
		if (i.hasRawStr()) {
